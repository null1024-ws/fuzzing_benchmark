# 1 "/benchmark/project/jhead-3.00/makernote.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/jhead-3.00/makernote.c" 2
...
extern int ShowTags;
# 6 "/benchmark/project/jhead-3.00/makernote.c" 2
        ...
        if (Tag == 4 && Format == 3){
            if (Components > 7){
                ...
                switch(WhiteBalance){
                    ...
                    case 1: ImageInfo.LightSource = 1; break;
                    case 2: ImageInfo.LightSource = 1; break;
                    case 3: ImageInfo.LightSource = 3; break;
                    case 4: ImageInfo.LightSource = 2; break;
                    case 5: ImageInfo.LightSource = 4; break;
                }
            }
