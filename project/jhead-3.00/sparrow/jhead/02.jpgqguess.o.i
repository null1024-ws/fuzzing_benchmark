# 1 "/benchmark/project/jhead-3.00/jpgqguess.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/jhead-3.00/jpgqguess.c" 2
...
extern int ShowTags;
# 10 "/benchmark/project/jhead-3.00/jpgqguess.c" 2
...
# 81 "/benchmark/project/jhead-3.00/jpgqguess.c"
 void process_DQT (const uchar * Data, int length)
{
    int a;
    int c;
...
# 170 "/benchmark/project/jhead-3.00/jpgqguess.c"
void process_DHT (const uchar * Data, int length)
{
    int a, i;
    int c, c2;
