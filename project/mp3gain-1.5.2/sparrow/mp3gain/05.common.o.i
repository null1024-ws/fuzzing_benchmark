# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c" 2
...
# 8 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c" 2
...
# 9 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c" 2
...
# 10 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 11 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c" 2
# 21 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c"
...
# 22 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c" 2
...
# 27 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/mpg123.h"
...
# 25 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c" 2
# 36 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c"
extern const int tabsel_123 [2] [3] [16];
...
int pcm_point = 0;
# 92 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c"
int head_check(unsigned long head,int check_layer)
{
 ...
 return 0;
  ...
  if (check_layer>0) {
      if (nLayer != check_layer) return 0;
  }
...
int decode_header(struct frame *fr,unsigned long newhead)
{
    ...
    switch(fr->lay)
    {
# 207 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c"
      case 3:
# 220 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/common.c"
