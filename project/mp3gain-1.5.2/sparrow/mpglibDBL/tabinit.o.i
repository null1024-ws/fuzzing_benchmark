# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.c" 2
...
# 8 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.c" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.h" 1
# 22 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.h"
...
# 23 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.h" 2

extern double decwin[512+32];
extern double *pnts[5];

void make_decode_tables(long scale);
# 9 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.c" 2
...
void make_decode_tables(long scaleval)
{
  ...
  for(i=0;i<5;i++)
  {
    ...
    costab = pnts[i];
    for(k=0;k<kr;k++)
      costab[k] = (double)( 1.0 / (2.0 * cos(3.14159265358979323846 * ((double) k * 2.0 + 1.0) / (double) divv)) );
  }
