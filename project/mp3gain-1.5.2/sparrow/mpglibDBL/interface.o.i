# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
...
# 8 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
...
# 9 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 10 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
...
# 12 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.h" 1
# 23 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.h"
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/../gain_analysis.h" 1
# 31 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/../gain_analysis.h"
...
# 32 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/../gain_analysis.h" 2
# 44 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/../gain_analysis.h"
...
# 24 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.h" 2
...
# 13 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.h" 1
# 24 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/tabinit.h"
extern double decwin[512+32];
extern double *pnts[5];

void make_decode_tables(long scale);
# 14 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/layer3.h" 1
# 22 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/layer3.h"
void init_layer3(int);
int do_layer3_sideinfo(struct frame *fr);
int do_layer3( PMPSTR mp,int *pcm_point);
# 15 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/VbrTag.h" 1
# 25 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/VbrTag.h"
# 1 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/config.h" 1
# 81 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/config.h"
typedef long double ieee854_float80_t;
typedef double ieee754_float64_t;
typedef float ieee754_float32_t;
# 26 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/VbrTag.h" 2
# 57 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/VbrTag.h"
typedef struct
{
  int h_id;
  int samprate;
...
int PutLameVBR(lame_global_flags *gfp, FILE *fpStream, u_char *pbtStreamBuffer, unsigned int id3v2size, unsigned short crc);
void AddVbrFrame(lame_global_flags *gfp);
void ReportLameTagProgress(lame_global_flags *gfp,int nStart);
# 16 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c" 2
# 30 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c"
int InitMP3( PMPSTR mp)
{
...
# 320 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c"
 return 1;
}
# 335 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c"
...
int decodeMP3( PMPSTR mp,unsigned char *in,int isize,int *done)
{
 ...
 if(!mp->header_parsed) {
  ...
  if (mp->vbr_header) {
      ...
      if (bytes+vbrbytes > mp->bsize) return 1;
  ...
  *done = 0;
  ...
  switch (mp->fr.lay)
  {
# 642 "/benchmark/project/mp3gain-1.5.2/mpglibDBL/interface.c"
   case 3:
