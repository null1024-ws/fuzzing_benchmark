# 1 "/benchmark/project/cflow-1.6/src/symbol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/src/symbol.c" 2
# 17 "/benchmark/project/cflow-1.6/src/symbol.c"
# 1 "./cflow.h" 1
# 18 "./cflow.h"
# 1 "../config.h" 1
# 19 "./cflow.h" 2
...
# 18 "/benchmark/project/cflow-1.6/src/symbol.c" 2
# 1 "./parser.h" 1
# 18 "./parser.h"
enum {
     LBRACE = '{',
...
# 19 "/benchmark/project/cflow-1.6/src/symbol.c" 2
# 1 "../gnu/hash.h" 1
# 29 "../gnu/hash.h"
# 1 "../gnu/stdio.h" 1
# 23 "../gnu/stdio.h" 3
...
# 20 "/benchmark/project/cflow-1.6/src/symbol.c" 2
...
# 218 "/benchmark/project/cflow-1.6/src/symbol.c"
static void
static_free(void *data)
{
   ...
   if (print_option == 0x01 && include_symbol(sym)) {
        unlink_symbol(sym);
...
collect_functions(Symbol ***return_sym)
{
     ...
     if (snum)
   for (p = ((static_func_list) ? (static_func_list)->head : ((void*)0)); p; p = p->next)
        symbols[num++] = p->data;
     *return_sym = symbols;
     return num;
}
