# 1 "/benchmark/project/cflow-1.6/src/depmap.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/src/depmap.c" 2
# 17 "/benchmark/project/cflow-1.6/src/depmap.c"
# 1 "./cflow.h" 1
# 18 "./cflow.h"
# 1 "../config.h" 1
# 19 "./cflow.h" 2
...
# 18 "/benchmark/project/cflow-1.6/src/depmap.c" 2
# 29 "/benchmark/project/cflow-1.6/src/depmap.c"
static void
transitive_closure(unsigned *R, int n)
{
     ...
     rowsize = (((n) + (sizeof(unsigned)*8) - 1) / (sizeof(unsigned)*8)) * sizeof (unsigned);
...
{
     size_t size = (count + (sizeof(unsigned)*8) - 1) / (sizeof(unsigned)*8);
...
{
     unsigned *rptr = depmap_rowptr(dmap, row);
     return (((rptr)[(col)/(sizeof(unsigned)*8)] & (1<<((col) % (sizeof(unsigned)*8)))) != 0);
}
