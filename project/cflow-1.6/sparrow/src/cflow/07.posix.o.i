# 1 "/benchmark/project/cflow-1.6/src/posix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/src/posix.c" 2
# 17 "/benchmark/project/cflow-1.6/src/posix.c"
# 1 "./cflow.h" 1
# 18 "./cflow.h"
# 1 "../config.h" 1
# 19 "./cflow.h" 2
...
# 18 "/benchmark/project/cflow-1.6/src/posix.c" 2
...
# 19 "/benchmark/project/cflow-1.6/src/posix.c" 2
       ...
       void *data, void *handler_data)
{
   ...
   if (emacs_option)
        error(3, 0,
       dcgettext (((void*)0), "--format=posix is not compatible with --emacs", 5));
