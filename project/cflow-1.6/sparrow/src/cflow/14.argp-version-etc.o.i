# 1 "/benchmark/project/cflow-1.6/gnu/argp-version-etc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/gnu/argp-version-etc.c" 2
# 19 "/benchmark/project/cflow-1.6/gnu/argp-version-etc.c"
# 1 "../config.h" 1
# 20 "/benchmark/project/cflow-1.6/gnu/argp-version-etc.c" 2
# 1 "./version-etc.h" 1
# 24 "./version-etc.h"
...
# 21 "/benchmark/project/cflow-1.6/gnu/argp-version-etc.c" 2
# 1 "./argp.h" 1
# 24 "./argp.h"
# 1 "./stdio.h" 1
# 23 "./stdio.h" 3
...
# 22 "/benchmark/project/cflow-1.6/gnu/argp-version-etc.c" 2
# 1 "./argp-version-etc.h" 1
# 36 "./argp-version-etc.h"
extern void argp_version_setup (const char *name, const char * const *authors);
# 23 "/benchmark/project/cflow-1.6/gnu/argp-version-etc.c" 2
...
{
  version_etc_ar (stream, program_canonical_name, "GNU cflow", "1.6",
                  program_authors);
}
