# 1 "/benchmark/project/cflow-1.6/src/rc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/src/rc.c" 2
# 17 "/benchmark/project/cflow-1.6/src/rc.c"
# 1 "./cflow.h" 1
# 18 "./cflow.h"
# 1 "../config.h" 1
# 19 "./cflow.h" 2
...
# 18 "/benchmark/project/cflow-1.6/src/rc.c" 2
# 1 "./parser.h" 1
# 18 "./parser.h"
enum {
     LBRACE = '{',
...
# 19 "/benchmark/project/cflow-1.6/src/rc.c" 2
# 1 "../gnu/sys/stat.h" 1
# 28 "../gnu/sys/stat.h" 3
# 43 "../gnu/sys/stat.h" 3
# 1 "../gnu/sys/types.h" 1 3
# 23 "../gnu/sys/types.h" 3
# 44 "../gnu/sys/stat.h" 2 3
...
# 50 "../gnu/sys/stat.h" 2 3
# 1038 "../gnu/sys/stat.h" 3
extern int _gl_cxxalias_dummy;


extern int _gl_cxxalias_dummy;
# 1084 "../gnu/sys/stat.h" 3
extern int _gl_cxxalias_dummy;


extern int _gl_cxxalias_dummy;
# 20 "/benchmark/project/cflow-1.6/src/rc.c" 2
...
# 21 "/benchmark/project/cflow-1.6/src/rc.c" 2
# 1 "./wordsplit.h" 1
# 20 "./wordsplit.h"
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 21 "./wordsplit.h" 2
...
# 22 "/benchmark/project/cflow-1.6/src/rc.c" 2
...
parse_rc(int *argc_ptr, char ***argv_ptr, char *name)
{
   ...
   return;
     ...
     rcfile = fopen(name, "r");
     if (!rcfile) {
   error(1, (*__errno_location ()), dcgettext (((void*)0), "cannot open `%s'", 5), name);
   return;
     }
     ...
     ws.ws_comment = "#";
     wsflags = (0x00000040 | 0x00000004 | (0x00000200|0x00000400) | 0x00000800 | 0x02000000) | 0x00008000;
     line = 0;
     for (p = strtok(buf, "\n"); p; p = strtok(((void*)0), "\n")) {
   ++line;
   ...
   if (ws.ws_wordc)
     ...
     if (wsflags & 0x00000008)
   wordsplit_free(&ws);
     free(buf);
}
# 90 "/benchmark/project/cflow-1.6/src/rc.c"
void
sourcerc(int *argc_ptr, char ***argv_ptr)
{
   ...
   ws.ws_comment = "#";
   if (wordsplit(env, &ws, (0x00000040 | 0x00000004 | (0x00000200|0x00000400) | 0x00000800 | 0x02000000) | 0x00008000))
   ...
   if (home) {
        int len = strlen(home);
        char *buf = malloc(len + sizeof(".cflowrc")
      + (home[len-1] != '/') );
        if (!buf)
      return;
        strcpy(buf, home);
