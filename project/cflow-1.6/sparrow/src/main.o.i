# 1 "/benchmark/project/cflow-1.6/src/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/src/main.c" 2
# 17 "/benchmark/project/cflow-1.6/src/main.c"
# 1 "./cflow.h" 1
# 18 "./cflow.h"
# 1 "../config.h" 1
# 19 "./cflow.h" 2
...
# 37 "../gnu/getopt.h" 2 3
# 90 "../gnu/getopt.h" 3
# 1 "../gnu/getopt-pfx-ext.h" 1 3
# 71 "../gnu/getopt-pfx-ext.h" 3
# 1 "../gnu/getopt-ext.h" 1 3
# 52 "../gnu/getopt-ext.h" 3
struct rpl_option
{
  const char *name;
...
# 1 "../gnu/xalloc-oversized.h" 1
# 23 "../gnu/xalloc-oversized.h"
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 24 "../gnu/xalloc-oversized.h" 2
# 36 "../gnu/xalloc-oversized.h"
...
# 18 "/benchmark/project/cflow-1.6/src/main.c" 2
# 1 "../gnu/argp.h" 1
# 24 "../gnu/argp.h"
# 1 "../gnu/stdio.h" 1
# 23 "../gnu/stdio.h" 3
...
inline int
__attribute__ ((__nothrow__ )) _option_is_short (const struct argp_option *__opt)
{
  if (__opt->flags & 0x8)
    return 0;
  else
...
inline int
__attribute__ ((__nothrow__ )) _option_is_end (const struct argp_option *__opt)
{
  return !__opt->key && !__opt->name && !__opt->doc && !__opt->group;
}
# 19 "/benchmark/project/cflow-1.6/src/main.c" 2
# 1 "../gnu/argp-version-etc.h" 1
# 36 "../gnu/argp-version-etc.h"
extern void argp_version_setup (const char *name, const char * const *authors);
# 20 "/benchmark/project/cflow-1.6/src/main.c" 2
# 1 "../gnu/progname.h" 1
# 34 "../gnu/progname.h"
...
# 21 "/benchmark/project/cflow-1.6/src/main.c" 2
...
# 23 "/benchmark/project/cflow-1.6/src/main.c" 2
# 1 "../gnu/version-etc.h" 1
# 25 "../gnu/version-etc.h"
# 1 "../gnu/stdio.h" 1
# 23 "../gnu/stdio.h" 3
# 26 "../gnu/version-etc.h" 2
# 36 "../gnu/version-etc.h"
extern const char version_etc_copyright[];
# 54 "../gnu/version-etc.h"
...
# 24 "/benchmark/project/cflow-1.6/src/main.c" 2

const char *argp_program_bug_address = "<" "bug-cflow@gnu.org" ">";
static char doc[] = "generate a program flowgraph"
"\v"
...
static struct argp_option options[] = {
     ...
     { ((void*)0), 0, ((void*)0), 0,
       "General options:", 0 },
     { "depth", 'd', "NUMBER", 0,
       "Set the depth at which the flowgraph is cut off", 0 +1 },
     { "include", 'i', "CLASSES", 0,
       "Include specified classes of symbols (see below). Prepend CLASSES with ^ or - to exclude them from the output", 0 +1 },
     { "format", 'f', "NAME", 0,
       "Use given output format NAME. Valid names are `gnu' (default) and `posix'",
       0 +1 },
     { "reverse", 'r', ((void*)0), 0,
       "* Print reverse call tree", 0 +1 },
     { "xref", 'x', ((void*)0), 0,
       "Produce cross-reference listing only", 0 +1 },
     { "print", 'P', "OPT", 0x2,
     ...
     { ((void*)0), 0, ((void*)0), 0, "Symbols classes for --include argument", 0 +2 },
     {"  x", 0, ((void*)0), 0x8|0x20,
      "all data symbols, both external and static", 0 +3 },
     {"  _", 0, ((void*)0), 0x8|0x20,
      "symbols whose names begin with an underscore", 0 +3 },
     {"  s", 0, ((void*)0), 0x8|0x20,
      "static symbols", 0 +3 },
     {"  t", 0, ((void*)0), 0x8|0x20,
      "typedefs (for cross-references only)", 0 +3 },
     ...
     { ((void*)0), 0, ((void*)0), 0,
       "Parser control:", 10 },
     { "use-indentation", 'S', ((void*)0), 0,
       "* Rely on indentation", 10 +1 },
     { "no-use-indentation", OPT_NO_USE_INDENTATION, ((void*)0), 0x2,
       "", 10 +1 },
     { "ansi", 'a', ((void*)0), 0,
       "* Accept only sources in ANSI C", 10 +1 },
     { "no-ansi", OPT_NO_ANSI, ((void*)0), 0x2,
       "", 10 +1 },
     { "pushdown", 'p', "NUMBER", 0,
       "Set initial token stack size to NUMBER", 10 +1 },
     { "symbol", 's', "SYMBOL:[=]TYPE", 0,
       "Register SYMBOL with given TYPE, or define an alias (if := is used). Valid types are: keyword (or kw), modifier, qualifier, identifier, type, wrapper. Any unambiguous abbreviation of the above is also accepted", 10 +1 },
     { "main", 'm', "NAME", 0,
       "Assume main function to be called NAME", 10 +1 },
     { "no-main", OPT_NO_MAIN, ((void*)0), 0,
       "There's no main function; print graphs for all functions in the program" },
     { "define", 'D', "NAME[=DEFN]", 0,
       "Predefine NAME as a macro", 10 +1 },
     { "undefine", 'U', "NAME", 0,
       "Cancel any previous definition of NAME", 10 +1 },
     { "include-dir", 'I', "DIR", 0,
       "Add the directory DIR to the list of directories to be searched for header files.", 10 +1 },
     { "preprocess", OPT_PREPROCESS, "COMMAND", 0x1,
       "* Run the specified preprocessor command", 10 +1 },
     { "cpp", 0, ((void*)0), 0x4, ((void*)0), 10 +1 },
     { "no-preprocess", OPT_NO_PREPROCESS, ((void*)0), 0x2,
       "", 10 +1 },
     { "no-cpp", 0, ((void*)0), 0x4|0x2, ((void*)0), 10 +1 },


     { ((void*)0), 0, ((void*)0), 0,
       "Output control:", 20 },
     { "all", 'A', ((void*)0), 0,
       "Show all functions, not only those reachable from main",
       20 +1 },
     { "number", 'n', ((void*)0), 0,
       "* Print line numbers", 20 +1 },
     { "no-number", OPT_NO_NUMBER, ((void*)0), 0x2,
       "", 20 +1 },
     { "print-level", 'l', ((void*)0), 0,
       "* Print nesting level along with the call tree", 20 +1 },
     { "no-print-level", OPT_NO_PRINT_LEVEL, ((void*)0), 0x2,
       "", 20 +1 },
     { "level-indent", OPT_LEVEL_INDENT, "ELEMENT", 0,
       "Control graph appearance", 20 +1 },
     { "tree", 'T', ((void*)0), 0,
       "* Draw ASCII art tree", 20 +1 },
     { "no-tree", OPT_NO_TREE, ((void*)0), 0x2,
       "", 20 +1 },
     { "brief", 'b', ((void*)0), 0,
       "* Brief output", 20 +1 },
     { "no-brief", OPT_NO_BRIEF, ((void*)0), 0x2,
       "", 20 +1 },
     { "emacs", OPT_EMACS, ((void*)0), 0,
       "* Additionally format output for use with GNU Emacs", 20 +1 },
     { "no-emacs", OPT_NO_EMACS, ((void*)0), 0x2,
       "", 20 +1 },
     { "omit-arguments", OPT_OMIT_ARGUMENTS, ((void*)0), 0,
       "* Do not print argument lists in function declarations", 20 +1 },
     { "no-ignore-arguments", OPT_NO_OMIT_ARGUMENTS, ((void*)0), 0x2,
       "", 20 +1 },
     { "omit-symbol-names", OPT_OMIT_SYMBOL_NAMES, ((void*)0), 0,
       "* Do not print symbol names in declaration strings", 20 +1 },
     { "no-omit-symbol-names", OPT_NO_OMIT_SYMBOL_NAMES, ((void*)0), 0x2,
       "", 20 +1 },
     ...
     { "verbose", 'v', ((void*)0), 0,
       "* Verbose error diagnostics", 30 +1 },
     { "no-verbose", OPT_NO_VERBOSE, ((void*)0), 0x2,
       "", 30 +1 },
     { "debug", OPT_DEBUG, "NUMBER", 0x1,
       "Set debugging level", 30 +1 },
...
# 215 "/benchmark/project/cflow-1.6/src/main.c"
int symbol_map;

char *level_indent[] = { ((void*)0), ((void*)0) };
char *level_end[] = { "", "" };
char *level_begin = "";
...
symbol_override(const char *str)
{
     ...
     ptr = strchr(str, ':');
     if (!ptr)
   error(3, 0, dcgettext (((void*)0), "%s: no symbol type supplied", 5), str);
     else {
   name = strndup(str, ptr - str);
   if (ptr[1] == '=') {
        Symbol *alias = lookup(ptr+2);
        if (!alias) {
      alias = install(xstrdup(ptr+2), 0x01);
      alias->type = SymToken;
      alias->token_type = 0;
      alias->source = ((void*)0);
      alias->def_line = -1;
      alias->ref_line = ((void*)0);
        }
        sp = install(name, 0x01);
        sp->type = SymToken;
        sp->alias = alias;
        ...
        if (type == 0)
      error(3, 0, dcgettext (((void*)0), "unknown symbol type: %s", 5), ptr+1);
        sp = install(name, 0x01);
        sp->type = SymToken;
        sp->token_type = type;
   }
...
set_print_option(char *str)
{
     ...
     if (opt == 0) {
   error(3, 0, dcgettext (((void*)0), "unknown print option: %s", 5), str);
   return;
     }
     print_option |= opt;
}
...
number(const char **str_ptr, int base, int count)
{
   ...
   if (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISdigit))
        ...
        i = (__extension__ ({ int __res; if (sizeof (c) > 1) { if (__builtin_constant_p (c)) { int __c = (c); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (c); } else __res = (*__ctype_toupper_loc ())[(int) (c)]; __res; })) - 'A' + 10;
   if (i > base) {
        break;
   }
   n = n * base + i;
...
# 371 "/benchmark/project/cflow-1.6/src/main.c"
...
parse_level_string(const char *str, char **return_ptr)
{
   ...
   case 'x':
      ...
      *p++ = c;
      if (*p == 0)
    error(3, 0,
          dcgettext (((void*)0), "level indent string is too long", 5));
        }
        break;
   default:
   copy:
        *p++ = *str++;
        if (*p == 0)
      error(3, 0, dcgettext (((void*)0), "level indent string is too long", 5));
   }
     }
     *p = 0;
...
set_level_indent(const char *str)
{
   ...
   return;
     ...
     while (*p != '=') {
   if (*p == 0)
        error(3, 0, dcgettext (((void*)0), "level-indent syntax", 5));
   p++;
     }
     ++p;
   ...
   break;
     default:
   error(3, 0, dcgettext (((void*)0), "unknown level indent option: %s", 5), str);
     }
}
...
parse_opt (int key, char *arg, struct argp_state *state)
{
   ...
   break;
     case OPT_NO_TREE:
   print_as_tree = 0;
   level_indent[0] = level_indent[1] = ((void*)0);
   level_end[0] = level_end[1] = ((void*)0);
   break;
     case 'b':
   brief_listing = 1;
   break;
   ...
   if (select_output_driver(arg))
        error(3, 0, dcgettext (((void*)0), "%s: No such output driver", 5), rpl_optarg);
   output_init();
   break;
   ...
   for (; *arg; arg++)
      ...
      break;
        ...
        case 'u':
      if (num)
    (symbol_map |= ((*arg)=='x' ? 0x0002 : (*arg)=='_' ? 0x0008 : (*arg)=='s' ? 0x0004 : (*arg)=='t' ? 0x0010 : (*arg)=='u' ? 0x0020 : 0));
      else
    (symbol_map &= ~((*arg)=='x' ? 0x0002 : (*arg)=='_' ? 0x0008 : (*arg)=='s' ? 0x0004 : (*arg)=='t' ? 0x0010 : (*arg)=='u' ? 0x0020 : 0));
      break;
        default:
      error(3, 0, dcgettext (((void*)0), "Unknown symbol class: %c", 5), *arg);
        }
   break;
   ...
   break;
     case 'x':
   print_option = 0x01;
   (symbol_map &= ~(('s')=='x' ? 0x0002 : ('s')=='_' ? 0x0008 : ('s')=='s' ? 0x0004 : ('s')=='t' ? 0x0010 : ('s')=='u' ? 0x0020 : 0));
   break;
     case OPT_PREPROCESS:
   preprocess_option = 1;
   set_preprocessor(arg ? arg : "/usr/bin/cpp");
   break;
...
xalloc_die(void)
{
     error(1, 12, dcgettext (((void*)0), "Exiting", 5));
     abort();
}
...
init()
{
     if (level_indent[0] == ((void*)0))
   level_indent[0] = "    ";
     if (level_indent[1] == ((void*)0))
   level_indent[1] = level_indent[0];
     if (level_end[0] == ((void*)0))
   level_end[0] = "";
     if (level_end[1] == ((void*)0))
   level_end[1] = "";
...
main(int argc, char **argv)
{
     ...
     symbol_map = 0x0001|0x0004|0x0020;

     if (getenv("POSIXLY_CORRECT")) {
   if (select_output_driver("posix")) {
        error(0, 0, dcgettext (((void*)0), "INTERNAL ERROR: %s: No such output driver", 5),
       "posix");
        abort();
   }
   output_init();
     ...
     sourcerc(&argc, &argv);
     if (argp_parse(&argp, argc, argv, 0x08, &index, ((void*)0)))
   exit(3);
   ...
   for (p = ((arglist) ? (arglist)->head : ((void*)0)); p; ) {
   ...
   for (p = ((arglist) ? (arglist)->head : ((void*)0)); p; p = p->next) {
        char *s = (char*)p->data;
        if (source(s) == 0)
      yyparse();
   }
   ...
   if (source(*argv++) == 0)
     ...
     if (input_file_count == 0)
      error(3, 0, dcgettext (((void*)0), "no input files", 5));
