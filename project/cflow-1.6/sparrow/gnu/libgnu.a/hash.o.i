# 1 "/benchmark/project/cflow-1.6/gnu/hash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/gnu/hash.c" 2
# 27 "/benchmark/project/cflow-1.6/gnu/hash.c"
# 1 "../config.h" 1
# 28 "/benchmark/project/cflow-1.6/gnu/hash.c" 2
...
# 30 "/benchmark/project/cflow-1.6/gnu/hash.c" 2
...
{
  return ((x << n) | (x >> (64 - n))) & (18446744073709551615UL);
}
...
# 32 "/benchmark/project/cflow-1.6/gnu/hash.c" 2
# 1 "./xalloc-oversized.h" 1
# 23 "./xalloc-oversized.h"
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 24 "./xalloc-oversized.h" 2
# 36 "./xalloc-oversized.h"
typedef ptrdiff_t __xalloc_count_type;
# 33 "/benchmark/project/cflow-1.6/gnu/hash.c" 2


# 1 "./stdio.h" 1
# 23 "./stdio.h" 3
# 36 "/benchmark/project/cflow-1.6/gnu/hash.c" 2
# 1 "./stdlib.h" 1
# 23 "./stdlib.h" 3
# 38 "./stdlib.h" 3
...
extern int _gl_cxxalias_dummy;
# 37 "/benchmark/project/cflow-1.6/gnu/hash.c" 2
# 48 "/benchmark/project/cflow-1.6/gnu/hash.c"
struct hash_entry
  {
    void *data;
...
# 132 "/benchmark/project/cflow-1.6/gnu/hash.c"
...
# 151 "/benchmark/project/cflow-1.6/gnu/hash.c"
size_t
...
# 289 "/benchmark/project/cflow-1.6/gnu/hash.c"
void *
...
# 369 "/benchmark/project/cflow-1.6/gnu/hash.c"
size_t
...
# 429 "/benchmark/project/cflow-1.6/gnu/hash.c"
size_t
...
next_prime (size_t candidate)
{
  ...
  while ((18446744073709551615UL) != candidate && !is_prime (candidate))
    candidate += 2;
...
# 513 "/benchmark/project/cflow-1.6/gnu/hash.c"
static _Bool
  ...
  if (!tuning->is_n_buckets)
    {
      ...
      if ((18446744073709551615UL) <= new_candidate)
        return 0;
      candidate = new_candidate;
    }
  candidate = next_prime (candidate);
  if (((size_t) ((9223372036854775807L) < (18446744073709551615UL) ? (9223372036854775807L) : (18446744073709551615UL) - 1) / (sizeof (struct hash_entry *)) < (candidate)))
    return 0;
  return candidate;
}
# 595 "/benchmark/project/cflow-1.6/gnu/hash.c"
Hash_table *
...
# 724 "/benchmark/project/cflow-1.6/gnu/hash.c"
  for (bucket = table->bucket; bucket < table->bucket_limit; bucket++)
    {
      for (cursor = bucket->next; cursor; cursor = next)
        {
...
# 944 "/benchmark/project/cflow-1.6/gnu/hash.c"
_Bool
...
# 986 "/benchmark/project/cflow-1.6/gnu/hash.c"
...
# 1014 "/benchmark/project/cflow-1.6/gnu/hash.c"
  table->free_entry_list = new_table->free_entry_list;
...
# 1039 "/benchmark/project/cflow-1.6/gnu/hash.c"
int
      ...
      > table->tuning->growth_threshold * table->n_buckets)
    {
      ...
      if (table->n_buckets_used
          > table->tuning->growth_threshold * table->n_buckets)
        {
          ...
          if ((18446744073709551615UL) <= candidate)
            return -1;
