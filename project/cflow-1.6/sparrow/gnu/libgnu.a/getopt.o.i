# 1 "/benchmark/project/cflow-1.6/gnu/getopt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
# 23 "/benchmark/project/cflow-1.6/gnu/getopt.c"
# 1 "../config.h" 1
# 24 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
...
# 91 "./getopt.h" 2 3
# 37 "./getopt.h" 2 3
# 27 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
...
extern int _gl_cxxalias_dummy;
# 29 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
# 1 "./stdlib.h" 1
# 23 "./stdlib.h" 3
# 38 "./stdlib.h" 3
...
extern int _gl_cxxalias_dummy;
# 30 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
# 1 "./string.h" 1
# 23 "./string.h" 3
# 43 "./string.h" 3
...
extern int _gl_cxxalias_dummy;
# 31 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
# 1 "./unistd.h" 1
# 24 "./unistd.h" 3
# 42 "./unistd.h" 3
...
extern int _gl_cxxalias_dummy;
# 32 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
# 46 "/benchmark/project/cflow-1.6/gnu/getopt.c"
# 1 "./gettext.h" 1
# 28 "./gettext.h"
...
# 47 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
# 83 "/benchmark/project/cflow-1.6/gnu/getopt.c"
# 1 "./getopt_int.h" 1
# 27 "./getopt_int.h"
...
extern int _getopt_long_only_r (int ___argc, char **___argv,
    ...
    int *__longind,
    struct _getopt_data *__data);
# 84 "/benchmark/project/cflow-1.6/gnu/getopt.c" 2
...
char *rpl_optarg;
# 106 "/benchmark/project/cflow-1.6/gnu/getopt.c"
int rpl_optind = 1;
...
# 132 "/benchmark/project/cflow-1.6/gnu/getopt.c"
static void
...
# 195 "/benchmark/project/cflow-1.6/gnu/getopt.c"
static int
       ...
       int print_errors, const char *prefix)
{
      ...
      if (ambig_set || ambig_fallback)
 {
       ...
       else
  {
    flockfile (stderr);
    fprintf (stderr,
      dcgettext (((void*)0), "%s: option '%s%s' is ambiguous; possibilities:", 5),
      argv[0], prefix, d->__nextchar);
...
static const char *
_getopt_initialize (int argc __attribute__ ((__unused__)),
...
# 472 "/benchmark/project/cflow-1.6/gnu/getopt.c"
int
      ...
      int long_only, struct _getopt_data *d, int posixly_correct)
{
      ...
      if (d->__ordering == PERMUTE)
 {
   ...
   d->__last_nonopt = d->rpl_optind;
      ...
      if (d->rpl_optind != argc && !strcmp (argv[d->rpl_optind], "--"))
 {
   d->rpl_optind++;
...
# 593 "/benchmark/project/cflow-1.6/gnu/getopt.c"
   if (long_only && (argv[d->rpl_optind][2]
       || !strchr (optstring, argv[d->rpl_optind][1])))
     {
       int code;
...
# 741 "/benchmark/project/cflow-1.6/gnu/getopt.c"
