# 1 "/benchmark/project/cflow-1.6/gnu/malloca.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/cflow-1.6/gnu/malloca.c" 2
# 21 "/benchmark/project/cflow-1.6/gnu/malloca.c"
# 1 "../config.h" 1
# 22 "/benchmark/project/cflow-1.6/gnu/malloca.c" 2
...
# 25 "/benchmark/project/cflow-1.6/gnu/malloca.c" 2

# 1 "./verify.h" 1
# 49 "./verify.h"
# 1 "/usr/local/lib/clang/12.0.0/include/stddef.h" 1 3
# 50 "./verify.h" 2
# 27 "/benchmark/project/cflow-1.6/gnu/malloca.c" 2
# 40 "/benchmark/project/cflow-1.6/gnu/malloca.c"
typedef unsigned char small_t;

extern int (*_gl_verify_function2 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (2 * sa_alignment_max - 1 <= (small_t) -1) ? 1 : -1; }))];
