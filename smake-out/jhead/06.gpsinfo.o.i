# 1 "/benchmark/project/jhead-3.00/gpsinfo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/jhead-3.00/gpsinfo.c" 2
...
extern int ShowTags;
# 7 "/benchmark/project/jhead-3.00/gpsinfo.c" 2
# 19 "/benchmark/project/jhead-3.00/gpsinfo.c"
static const char * GpsTags[0x1e +1]= {
    "VersionID       ",
    "LatitudeRef     ",
    "Latitude        ",
    "LongitudeRef    ",
